...
carcassonne_first = {io: File.open('Seed_images/carca1.jpeg'), filename: 'ticket_first_photo'}
carcassonne_second = {io: File.open('Seed_images/carca2.jpeg'), filename: 'ticket_second_photo'}
carcassonne.photos.attach([carca_first, carca_second])
...
ticket_second = {io: File.open('Seed_images/ticket2.jpg'), filename: 'carca_second_photo'}
...
dorado_first = {io: File.open('Seed_images/dorado1.jpeg'), filename: 'dorado_first_photo'}
...
dixit_first = {io: file.open('Seed_images/dixit1.jpeg'), filename: 'dixit_first_photo'}
dixit_second = {io: file.open('Seed_images/dixit4.jpeg'), filename: 'dixit_second_photo'}
dixit.photos.attach([dixit_first, dixit_second])
...
dixit_first = {io: file.open('Seed_images/dixit2.jpg'), filename: 'dixit_first_photo'}
dixit_second = {io: file.open('Seed_images/dixit5.jpeg'), filename: 'dixit_second_photo'}
dixit.photos.attach([dixit_first, dixit_second])
...
dixit_first = {io: file.open('Seed_images/dixit3.jpeg'), filename: 'dixit_first_photo'}
dixit_second = {io: file.open('Seed_images/dixit6.jpeg'), filename: 'dixit_second_photo'}
dixit.photos.attach([dixit_first, dixit_second])
...
wingspan_transaction = Transaction.create!( { offer_id: Offer.first.id, user_id: fabien.id, chosen_delivery: "Colissimo"} )
